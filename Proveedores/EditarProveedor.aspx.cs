    ...
    public partial class EditarProveedor : System.Web.UI.Page
    {
        ...
        protected void btnActualizar_Click(object sender, EventArgs e)
        {
            if (validarCampos())
            {
                ...
                if (proveedorEditar.cedula == txbCedulaProveedor.Text)
                {
                    ...
                    if (!proveedorServicios.existeProveedor(proveedorEditar.cedula))
                    {
                        proveedorEditar.tipoCedula = Convert.ToInt32(ddlTipoCedula.SelectedItem.Value);
                        proveedorEditar.nombre = txbNombreProveedor.Text;
                        proveedorEditar.telefono = txbTelefonoProveedor.Text;
        ...
        /// Fabián Quirós Masís
        /// 15/05/2018
        /// Efecto: Redirecciona a la pagina para administrar proveedores
        /// Requiere:-
        /// Modifica:-
        /// Devuelve:-
        /// </summary>
