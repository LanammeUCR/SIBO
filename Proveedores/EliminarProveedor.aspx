<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarProveedor.aspx.cs" Inherits="SIBO.Proveedores.EliminarProveedor" %>
    ...
    <div class="divRedondo">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
                        <asp:Label ID="lblAgregarProveedor" runat="server" Text="Eliminar Proveedor" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
            </div>
            <%-- fin titulo accion --%>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="col-md-2 col-xs-2 col-sm-2">
                    <asp:Label ID="lblTipoCedula" runat="server" Text="Tipo Identificación " Font-Size="Medium" ForeColor="Black" CssClass="label"></asp:Label>
                </div>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="col-md-2 col-xs-2 col-sm-2">
                    <asp:Label ID="lbCedulaProveedor" runat="server" Text="Cédula " Font-Size="Medium" ForeColor="Black" CssClass="label"></asp:Label>
                </div>
                <div class="col-md-4 col-xs-4 col-sm-4">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="col-md-2 col-xs-2 col-sm-2">
                    <asp:Label ID="lblNombreProveedor" runat="server" Text="Nombre Completo " Font-Size="Medium" ForeColor="Black" CssClass="label"></asp:Label>
                </div>
                <div class="col-md-4 col-xs-4 col-sm-4">
