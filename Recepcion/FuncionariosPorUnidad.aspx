...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="ViewContactos" runat="server" style="display: block">
        ...
        <div class="divRedondo">
            <div class="row">
                  <%-- variables hidden --%><input type="hidden" id="hdIdContacto" runat="server" /><%-- fin variables hidden --%><%-- titulo accion--%>
                ...
                <div class="col-md-4 col-xs-4 col-sm-4 col-md-offset-1 col-xs-offset-1 col-sm-offset-1">
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtBuscarFuncionariosAsociados" AutoPostBack="true" class="form-control" OnTextChanged="txtBuscarFuncionariosAsociados_TextChanged"></asp:TextBox>
