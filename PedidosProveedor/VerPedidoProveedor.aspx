<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerPedidoProveedor.aspx.cs" Inherits="SIBO.PedidosProveedor.VerPedidoProveedor" %>
    ...
    <div class="divRedondo">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12" style="text-align: center; top: 10px; left: 30px;">
                ...
                <asp:Repeater ID="rpVerSolicitudProveedor" runat="server" OnItemDataBound="rpDetalleUbicaciones_ItemDataBound">
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                   <asp:HiddenField ID="hfIdUbicacionesArticulo" runat="server" Value='<%# Eval("articulo.idArticulo") %>' />
            ...
            <div class="col-md-5 col-xs-5 col-sm-5 col-md-offset-9 col-xs-offset-9 col-sm-offset-9">
                <asp:Button ID="btnEnviar" runat="server" Text="Aceptar" CssClass="btn btn-primary" OnClick="btnAceptar_Pedido_Click" />
                &nbsp;
