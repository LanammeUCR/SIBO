    ...
    public partial class EditarArticulo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                txbExistenciasArticulo.Text = articuloEditar.cantidadTotal.ToString();
                txbExistenciasArticulo.Attributes.Add("oninput", "validarTexto(this)");
                txbCriticaArticulo.Text = articuloEditar.cantidadCritica.ToString();
                txbCriticaArticulo.Attributes.Add("oninput", "validarTexto(this)");
                cldFechaIngresoArticulo.SelectedDate = articuloEditar.fechaIngreso;
        ...
        protected void btnActualizar_Click(object sender, EventArgs e)
        {
            if (validarCampos())
            {
                ...
                articuloEditar.cantidadTotal = Convert.ToInt32(txbExistenciasArticulo.Text);
                articuloEditar.cantidadCritica = Convert.ToInt32(txbCriticaArticulo.Text);
                articuloEditar.fechaIngreso = cldFechaIngresoArticulo.SelectedDate;


                recepcionistaServicios.actualizarArticulo(articuloEditar, (String)Session["nombreCompleto"]);
