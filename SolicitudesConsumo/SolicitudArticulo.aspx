<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SolicitudArticulo.aspx.cs" Inherits="SIBO.Articulo.SolicitudArticulo" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="divRedondo">
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="col-md-2 col-xs-2 col-sm-2">
                <asp:Label ID="lblDescripcion" runat="server" Text="Descripción: <span style='color:red'>*</span> " CssClass="label" Font-Size="Medium" ForeColor="Black"></asp:Label>
            </div>
