<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerSolicitudConsumoFuncionario.aspx.cs" Inherits="SIBO.SolicitudesConsumo.VerSolicitudConsumoFuncionario" %>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                ...
                <div class="col-md-5 col-xs-5 col-sm-5 col-md-offset-9 col-xs-offset-9 col-sm-offset-9 ">
                    <asp:Button ID="btnEnviar" runat="server" Text="Aceptar" CssClass="btn btn-primary" OnClick="btnVolverSolicitud" Width="140px" />                                             
