...
{
    public partial class SolicitudArticuloFuncionario : System.Web.UI.Page
    {
        ...
        /// Fabián Quirós Masís
        /// 15/05/2018
        /// Efecto: Agrega un articulo a la lista de la solicitud
        /// Requiere:-
        /// Modifica:-
        /// Devuelve:-
        /// </summary>
        ...
        protected void btnAgregarArticuloLista(object sender, EventArgs e)
        {
            ...
            {
                articuloConsumo.cantidadEntregada = articuloConsumo.cantidadEntregar = 0;
