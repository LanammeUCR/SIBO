<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdministrarSolicitudesFuncionario.aspx.cs" Inherits="SIBO.Articulo.AdministrarSolicitudesFuncionario" %>
    ...
    <div class="divRedondo">
        <div class="row">
            ...
            <div class="col-md-2 col-xs-2 col-sm-2 col-md-offset-10 col-xs-offset-10 col-sm-offset-10">
                <asp:Button ID="btnArriba" runat="server" Text="Nueva Solicitud" CssClass="btn btn-primary" OnClick="btnNueva_Solicitud_Click" />
            </div>
            <%-- fin botones --%>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12" style="text-align: center; top: 10px; left: 30px;">
                ...
                <asp:Repeater ID="rpOrdenesConsumo" runat="server" OnItemDataBound="rpOrdenesConsumo_ItemDataBound">
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                ...
                                <asp:LinkButton ID="btnEditar" runat="server" ToolTip="Editar" OnClick="btnEditar_Click" CommandArgument='<%# Eval("idConsumo") %>' Visible='<%# Eval("rechazado") %>'><span class="btn glyphicon glyphicon-pencil"></span></asp:LinkButton>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:HiddenField ID="hfIdConsumo" runat="server" Value='<%# Eval("idConsumo") %>' />
            ...
            <%-- botones --%>
            <div class="col-md-2 col-xs-2 col-sm-2 col-md-offset-10 col-xs-offset-10 col-sm-offset-10">
                <asp:Button ID="btnnuevoAbajo" runat="server" Text="Nueva Solicitud" CssClass="btn btn-primary" OnClick="btnNueva_Solicitud_Click" />
            </div>
            <%-- fin botones --%>
