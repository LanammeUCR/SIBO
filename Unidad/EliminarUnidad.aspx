<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarUnidad.aspx.cs" Inherits="SIBO.Unidad.EliminarUnidad" %>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
             ...
             <div class="col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="col-md-4 col-xs-4 col-sm-4">
                    <asp:TextBox class="form-control" ID="txbTelefonoUnidad" runat="server" ReadOnly="True"></asp:TextBox>
                </div>
